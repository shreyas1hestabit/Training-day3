...
2.INITIAL STATE (Before Conflict)
    ...
    ![i](screenshots/Screenshot from 2026-01-08 18-33-53.png)
...
3.TEAM A CHANGES (repo-A)
    ...
    Code(Team A version)
    ![repoa](screenshots/Screenshot from 2026-01-08 18-37-58.png)
    Git commands used
    ![commita](screenshots/Screenshot from 2026-01-08 18-40-02.png)
...
4.TEAM B CHANGES (repo-b)
    ...
    Code(Team B version)
    ![repob](screenshots/Screenshot from 2026-01-08 17-50-53.png)
    Git commands used
    ![commitb](screenshots/Screenshot from 2026-01-08 18-44-24.png)
...
5.CREATING THE CONFLICT
    ...
    ![error](screenshots/Screenshot from 2026-01-08 18-46-56.png)
    
6.CONFLICT MAKERS IN FILE
![conflict](screenshots/Screenshot from 2026-01-08 17-03-24.png)
...
7.CONFLICT RESOLUTION DECISION
    ...
    ![res](screenshots/Screenshot from 2026-01-08 18-53-35.png)
    
8.COMPLETING THE MERGE
![mergecomplete](screenshots/Screenshot from 2026-01-08 18-55-15.png)

9.VERIFYING MERGE HISTORY
    --Merge commit is visible
    --Both Team A and Team B commits are preserved
    ![graph](screenshots/Screenshot from 2026-01-08 18-56-39.png)
